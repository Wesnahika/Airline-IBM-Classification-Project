...
In this firt visualization I want to look at each of the airlines and visualize the delays they may of had over the years. 



```{r}
ggplot(airline, aes (x = Year, y = DepDelay)) + 
  geom_line() +
  geom_point()
```
